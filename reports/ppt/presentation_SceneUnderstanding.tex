...
\begin{itemize}
\item Colored pointclouds (eg. Lai2011)
...
\begin{frame}{Captured Properties}
	...
	\begin{itemize}
                \item   {\bf Geometrical Context }
                \begin{itemize}
                \item Horiz. and Vert. distance b/w centroids
                \item Angle between normals
                \item Relative position from camera
                \end{itemize}
        \end{itemize}
        \column{.4\textwidth}
        \begin{figure}
        \vskip 0.1in
\includegraphics[width=.42\linewidth]{contextHole.png}
\hskip .1in
\includegraphics[width=.42\linewidth]{contextHoleFilled.png}
\end{figure}
        \end{columns}
...
model  & $P/R$ & Preci.  & \multicolumn{1}{c|}{Rec.} &  $P/R$ & Prec. &  \multicolumn{1}{c}{Rec.}  \\ 
baseline &  26.23 & 5.88 & 5.88 & 29.38 & 5.88 & 5.88\\
Image Only  & 46.67  & 35.73 & 31.67 &   38.00 & 15.03 & 14.50\\
Shape Only & 75.36  & 64.56 & 60.88 &    56.25 & 35.90 & 36.52 \\
Image+Shape  & 77.97  & 69.44 & 66.23 &   56.50 & 37.18 & 34.73 \\
Image+Shape \& context & 81.45  &76.79  &70.07   & 72.38  & 57.82  & 53.62 
\end{tabular}
\end{frame}
